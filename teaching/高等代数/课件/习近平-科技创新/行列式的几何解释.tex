...
%\begin{frame}
%我们反过来利用上面的三条基本性质来求三阶行列式:
%$$\begin{aligned} \operatorname{det}(\boldsymbol{\alpha}, \boldsymbol{\beta}, \boldsymbol{\gamma}) &=\operatorname{det}\left(a_1 \boldsymbol{e}_1+a_2 \boldsymbol{e}_2+a_3 \boldsymbol{e}_3, b_1 \boldsymbol{e}_1+a_2 \boldsymbol{e}_2+a_3 \boldsymbol{e}_3, c_1 \boldsymbol{e}_1+c_2 \boldsymbol{e}_2+c_3 \boldsymbol{e}_3\right) \\
%    & = \sum_{i=1}^3 \sum_{j=1}^3 \sum_{k=1}^3 a_i b_j c_k \operatorname{det}\left(\boldsymbol{e}_i, \boldsymbol{e}_j,\boldsymbol{e}_k\right) \\
%    & = \sum_{i,j,k} a_i b_j c_k \operatorname{det}\left(\boldsymbol{e}_i, \boldsymbol{e}_j,\boldsymbol{e}_k\right) \\ \end{aligned}$$
%其中的 $\sum$ 是对所有的排列 $i,j,k$ 求和.
%\end{frame}
