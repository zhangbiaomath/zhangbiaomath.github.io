...
\begin{frame}
	\begin{center}
		...
		\begin{tabular}{R{1.5cm}|R{3cm} |R{4cm}|L{1.7cm}}
			$-\frac{27}{5}x+9$  & \only<2->{$3x^3+10x^2+2x-3$}  &
             {$x^4+3x^3-x^2\, -4x-3$}&$\frac{1}{3}x-\frac{1}{9}$\\
			$=q_2(x)$ & $3x^3+15x^2+18x\quad $ & \only<1->{$x^4+\frac{10}{3}x^3+\frac{2}{3}x^2-x\qquad $}& $=q_1(x)$\\
			\cline{2-3}
			&$ -5x^2-16x-3$ & $-\frac{1}{3}x^3-\frac{5}{3}x^2-3x-3\, $ & \\
			&$ -5x^2-25x-30$ & $-\frac{1}{3}x^3-\frac{10}{9}x^2-\frac{2}{9}x+\frac{1}{3}$ & \\
			\cline{2-3}
			&\blue{$r_2(x) = 9x+27$} & \only<2->{\red{$r_1(x) =-\frac{5}{9}x^2-\frac{25}{9}x-\frac{10}{3}$}} & $-\frac{5}{81}x-\frac{10}{81}$\\
