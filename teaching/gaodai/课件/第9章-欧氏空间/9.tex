...
%\sum_{k=1}^{n} c_{k i} \varepsilon_{k}, i=1,2, \cdots, n$

因此, 
$\left(\eta_{i}, \eta_{j}\right) 
%=\left(\sum_{k=1}^{n} c_{k i} \varepsilon_{k}, \sum_{l=1}^{n} c_{l j} \varepsilon_{l}\right)=\sum_{k=1}^{n} \sum_{l=1}^{n}\left(\varepsilon_{k}, \varepsilon_{l}\right) c_{k i} c_{l j}$\\
%=\sum_{k=1}^{n} \sum_{l=1}^{n} a_{k l} c_{k i} c_{l j}
=C_{i}^{\, \prime} A C_{j}$.
...
\sol 
 因为
\[
|\lambda E-A|=| \begin{array}{ccc}
\lambda-2 & -2 & 2 \\
-2 & \lambda-5 & 4 \\
2 & 4 & \lambda-5
\end{array} |=(\lambda-1)^{2}(\lambda-10)
\]
